...
* `python 00_quick_test_ingestion.py --data-dir data/DOROTHEA/` (this may fail with "process killed" but only the generated ~900Mb parquet file is needed to proceed)
