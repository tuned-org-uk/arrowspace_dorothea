...
[2026-02-07T18:54:25Z INFO  arrowspace::builder] Early projection: 100000 features → 64 dimensions (ε=0.97)
[2026-02-07T18:54:35Z INFO  arrowspace::builder] Early projection complete: 1562.5x compression, 877 MB → 0 MB
...
[2026-02-07T18:54:38Z INFO  arrowspace::eigenmaps] EigenMaps::eigenmaps: Building Laplacian from 11 centroids × 64 features
...
[2026-02-07T18:54:38Z INFO  arrowspace::laplacian] Sparse Laplacian construction time: 157.544µs
...
[2026-02-07T18:54:38Z INFO  arrowspace::graph] Laplacian matrix built: 64×64 with 1150 nodes, 702 non-zeros
[2026-02-07T18:54:38Z INFO  arrowspace::eigenmaps] Laplacian construction complete: 64×64 matrix, 702 non-zeros, 82.86% sparse
[2026-02-07T18:54:38Z INFO  arrowspace::builder] Computing taumode lambdas with synthesis: Median
[2026-02-07T18:54:38Z INFO  arrowspace::eigenmaps] EigenMaps::compute_taumode: Computing λ values for 1150 items using Median
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] ╔═════════════════════════════════════════════════════════════╗
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] ║          Parallel TauMode Lambda Computation                ║
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] ╠═════════════════════════════════════════════════════════════╣
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] ║ Configuration:                                              ║
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] ║   Items:           1150                                     ║
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] ║   Features:        100000                                   ║
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] ║   Threads:         6                                        ║
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] ║   TauMode:         Median                                   ║
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] ║   Graph Source:    Laplacian Matrix                         ║
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] ║   Graph Shape:     64×64                                   ║
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] ║   Graph NNZ:       702                                      ║
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] ║   Graph Sparsity:  0.171387                                 ║
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] ╚═════════════════════════════════════════════════════════════╝
[2026-02-07T18:54:38Z INFO  arrowspace::taumode] Starting parallel lambda computation...
[2026-02-07T18:54:49Z INFO  arrowspace::taumode] ╔═════════════════════════════════════════════════════════════╗
[2026-02-07T18:54:49Z INFO  arrowspace::taumode] ║          Computation Statistics                             ║
[2026-02-07T18:54:49Z INFO  arrowspace::taumode] ╠═════════════════════════════════════════════════════════════╣
[2026-02-07T18:54:49Z INFO  arrowspace::taumode] ║   Sequential Items: 0                                       ║
[2026-02-07T18:54:49Z INFO  arrowspace::taumode] ║   Parallel Items:   0                                       ║
[2026-02-07T18:54:49Z INFO  arrowspace::taumode] ║   Compute Time:     10.618s                                 ║
...
[2026-02-07T18:54:49Z INFO  arrowspace::taumode] ║   Update Time:      34.861µs                                ║
[2026-02-07T18:54:49Z INFO  arrowspace::taumode] ║   Total Time:       10.618s                                 ║
[2026-02-07T18:54:49Z INFO  arrowspace::taumode] ║   Throughput:       108                                     items/sec ║
[2026-02-07T18:54:49Z INFO  arrowspace::taumode] ╚═════════════════════════════════════════════════════════════╝
[2026-02-07T18:54:49Z INFO  arrowspace::taumode] ✓ Parallel taumode lambda computation completed successfully
[2026-02-07T18:54:49Z INFO  arrowspace::eigenmaps] λ computation complete: min=0.000000, max=1.000000, mean=0.237317
...
| Metric | Hybrid (τ=0.72) | TauMode (τ=0.42) | Interpretation |
| :-- | :-- | :-- | :-- |
...
The high variance in the scores (Standard Deviation ~0.34–0.40) suggests the dataset contains two distinct types of queries:
...
* **TauMode** having a 0.0 median for Spearman correlation confirms that for many queries, it returns a completely different set of neighbors than Cosine. This is a feature, not a bug—it means it's finding "structural" neighbors rather than just "content" neighbors.
...
These classification results look internally consistent, and they also reveal something important about what your current “Hybrid / TauMode” settings are doing in *classification mode* (vs script 04’s ranking eval).[^1]
...
- **Baseline Cosine** and ArrowSpace **Cosine (τ=1.0)** are identical across k (and best at k≥10): BER **0.01087**, with confusion **TP=4, FN=0, FP=1, TN=45**.[^1]
...
Interpretation: Hybrid became conservative—**it stopped producing false positives** but missed 1 of the 4 positives.[^1]
- **TauMode** is best at k=5 (same as Hybrid there), but degrades for k≥10: BER **0.25** with recall **0.5** (so it only catches 2/4 positives).[^1]
...
- Importantly, **n_failed_queries=0 for all methods**: no λ=0 exceptions occurred during this classification run.[^1]


## Why this differs from script 04

Script 04 evaluates *ranking similarity* vs a cosine reference (NDCG/Spearman). Script 05 evaluates *label prediction* with majority vote. A method can be “novel” (low Spearman vs cosine) yet still classify well—or vice versa—depending on whether the neighbor set preserves class purity for the positives.[^1]

## Peer-review style critique (what to be careful about)

1. **The sample is extremely small on positives (4 positives)**, so BER changes are driven by 1–2 samples flipping.[^1]
This makes the apparent superiority of cosine at k≥10 plausible but statistically fragile.
2. **Hybrid and TauMode being worse than cosine is not necessarily bad** in ArrowSpace-as-database framing: it means the spectral/topology constraint is prioritizing “in-distribution structural neighbors,” which may not align with the class label signal in this tiny subset.[^1]
In other words: the spectral graph might be excellent for “record authenticity / manifold adherence” while being suboptimal for label propagation at this k/tau.
3. **Cosine and Baseline Cosine matching exactly** is a good sanity check that ArrowSpace’s cosine path is behaving like pure cosine kNN (at least for these 50 queries and your densification pipeline).[^1]

## Practical next steps (to learn more, fast)

- Re-run script 05 with **more validation queries** (ideally all 350) so positives aren’t only 4; otherwise conclusions about TauMode/Hybrid are too noisy.
- Sweep tau for Hybrid (0.6–0.9) and k (1–50). Your current Hybrid τ=0.72 might be too “spectral-heavy” for this classification objective, while still being good for “database-ness” / OOD detection.
...
If you want, I can also compute (from the CSV) an “expected confusion matrix” per method/k and summarize exactly how many positives each method missed and how many false positives it produced, but the key story is already visible in the metrics and counts above.[^1]

## Analysis

## 🚨 Critical Problem: Lambda Spread Collapse

This is the real issue buried in the logs:

```
Normalized lambdas to [0, 1] range (original spread: 0.009628)
λ computation complete: min=0.000000, max=1.000000, mean=0.237317
```


### Why This is Bad

**Original lambda spread = 0.0096** means that before normalization, all λ values were concentrated in a **tiny range** (e.g., [0.495, 0.505]). After stretching to, you have:[^2]
...
3. Result: **Isotropic distribution** → nearly uniform λ values (everything looks "equally rough")
...
def adaptive_densify(X_bin, base_noise=0.001, signal_boost=10.0, seed=42):
    ...
    # Real features (0-50k) have higher density → less noise
    # Probe features (50k-100k) have low density → can have more noise
...
### **Fix 3: Skip Full Densification—Use Sparse ArrowSpace**
...
- **More interpretable results** (λ reflects actual compound similarity, not noise geometry)
...
Run the classification script as-is to see if the collapsed λ values still provide *some* improvement over cosine. If BER is ≥20%, the noise-dominated manifold is too smooth.
...
Expected: λ spread ~0.05-0.15 (10x better), classification BER ~12-15%.
...
Expected: λ spread ~0.2-0.4, BER ~11-13%, **direct comparison to NIPS 2003 methods** (who also used sparse input).
...
Query \#21 from `dataset_64b6fa` received **λ = 0.0** during spectral search, triggering ArrowSpace's "undecidable query" safeguard and resulting in zero search results (NDCG = 0.0) for both Hybrid and TauMode configurations.

**Verdict: This is NOT a bug—it's a correctly detected out-of-distribution (OOD) query. However, it reveals a critical architectural weakness in error handling for production systems.**

***

### Technical Explanation: Why λ = 0.0?

#### What Lambda Measures

The spectral score λ (lambda) is computed via the **Rayleigh quotient**:
...
#### Interpretation of λ ≈ 0

When λ approaches zero (specifically < 1e-12 in the code), it means:

1. **Geometric Isolation**: The query lies in a "void" region with no indexed neighbors within the graph's epsilon threshold (ε = 0.97)[^1]
2. **Spectral Nullspace**: The query projects onto the constant eigenvector (eigenvalue = 0), indicating uniform similarity to all points—providing no discriminative signal
...
- The code explicitly guards against λ < 1e-12, not just floating-point noise[^1]
...
If Johnson-Lindenstrauss projection was applied (100k → 64 dims), the random projection matrix might have:
...
With ε = 0.97, the graph construction may have created an overly sparse connectivity structure, leaving some regions of the embedding space unreachable from query \#21.

#### H4: TauMode Computation Bug (2% Probability)

**Unlikely** — This would affect multiple queries, not just one isolated case.
...
1. ✗ Panic in Rust layer (caught by Python FFI)
2. ✗ Zero results returned to user
3. ✗ No fallback mechanism
4. ✗ No explanation of why search failed
...
The error message "Check your eps parameter" suggests ε=0.97 may be suboptimal for this dataset. Implement adaptive epsilon selection during build to maximize graph connectivity (target: 98%+ nodes reachable).

#### Low Priority (P3): OOD Monitoring

Log all queries with λ < 0.01 to detect dataset drift and inform retraining schedules.
...
2. **Graph Connectivity**: What percentage of indexed items are within ε=0.97 of query \#21? (Likely: 0%)
3. **Projection Impact**: Re-run without JL projection to isolate whether dimensionality reduction caused the collapse
4. **Epsilon Sensitivity**: Sweep ε ∈ [0.5, 0.7, 0.9, 0.99] and measure recall@10 for all 50 queries

***

### Conclusion

**This is a correctly detected anomaly, not a computational bug.** Query \#21 is genuinely out-of-distribution relative to the indexed manifold, and the spectral analysis correctly identified it as "undecidable" (λ → 0).

**However**, the system's response—panicking and returning zero results—is an **architectural flaw** for production deployment.
